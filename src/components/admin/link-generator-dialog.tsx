...
export function LinkGeneratorDialog({ onLinkGenerated, onClose }: LinkGeneratorDialogProps) {
  ...
  return (
    <DialogContent className="w-[80vw] h-[80vh] !max-w-[80vw] overflow-y-auto p-0">
      <DialogHeader className="px-6 pt-6">
        <DialogTitle>Generate Onboarding Link</DialogTitle>
      </DialogHeader>
      <form onSubmit={handleSubmit} className="space-y-6 px-6 pt-2 pb-6">
        {/* Basic Info */}
