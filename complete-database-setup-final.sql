...
-- for the complete VMM onboarding platform.
...
-- Insert a sample admin user (optional - remove if not needed)
-- Note: This requires an existing auth.users record with UUID '00000000-0000-0000-0000-000000000001'
-- INSERT INTO users (id, email, role, full_name, company_name) VALUES 
-- ('00000000-0000-0000-0000-000000000001', 'admin@example.com', 'admin', 'Admin User', 'Admin Company')
...
BEGIN
  ...
  RAISE NOTICE '🔗 onboarding_links table includes client_id column';
END $$;
