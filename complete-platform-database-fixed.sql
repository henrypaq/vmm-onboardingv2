-- =====================================================
-- COMPLETE PLATFORM DATABASE SETUP - FIXED VERSION
-- =====================================================
...
-- =====================================================
-- 4. ONBOARDING LINKS TABLE - FIXED VERSION
-- =====================================================
...
CREATE TABLE onboarding_links (
  ...
  is_used boolean DEFAULT false, -- FIXED: This column was missing from schema cache
  created_at timestamptz DEFAULT now(),
  updated_at timestamptz DEFAULT now()
);
...
CREATE INDEX IF NOT EXISTS idx_onboarding_links_is_used ON onboarding_links(is_used); -- FIXED: Added missing index
...
BEGIN
  ...
  RAISE NOTICE '✅ FIXED: is_used column properly configured';
